...
func (s *Bun) Start(ctx context.Context) error {
	opts := nats.Options{
		...
		Name:                 s.args.Name,
		AllowReconnect:       true,
		MaxReconnect:         s.args.GetMaxReconnect(),
		ReconnectWait:        s.args.GetReconnectWait(),
		Timeout:              s.args.GetTimeout(),
		DrainTimeout:         s.args.GetDrainTimeout(),
		FlusherTimeout:       s.args.GetFlusherTimeout(),
		PingInterval:         s.args.GetPingInterval(),
		MaxPingsOut:          s.args.GetMaxPingsOut(),
		User:                 s.args.User,
